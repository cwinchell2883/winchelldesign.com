...
$caption = $fdata['forum_cat_name']." :: <a href='viewforum.php?forum_id=".$sub_data['forum_id']."'>".$sub_data['forum_name']."</a> :: <a href='viewforum.php?forum_id=".$fdata['forum_id']."'>".$fdata['forum_name']."</a>";
}else{
