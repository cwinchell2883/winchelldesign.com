...
$data = dbarray(dbquery("SELECT tt.thread_lastpost
	...
	WHERE ".groupaccess('tf.forum_access')." AND tt.thread_sticky='1'
...
$result = dbquery(
	...
	WHERE ".groupaccess('tf.forum_access')." AND tt.thread_lastpost >= ".$timeframe." AND tt.thread_sticky='1'
...
while ($data = dbarray($result)) {
	...
	echo "</table>\n";
		...
		echo "<center><br />".$locale['fp105']."<br /><br /></center>\n";
