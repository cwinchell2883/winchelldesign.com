...
<?php $this->_cache_serials['/home/cwinchell/winchelldesign.com/iGnition/BACKEND6/tmp/templates_c/News^%%18^18E^18E3D89C%%module_db_tpl%3ANews%3BsummarySample.inc'] = 'f3c29c583651fdf32d2d3501a0f7450f'; ?><!-- Start News Display Template -->
<ul class="list1">
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:f3c29c583651fdf32d2d3501a0f7450f#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('f3c29c583651fdf32d2d3501a0f7450f','0');echo smarty_cms_function_repeat(array('string' => "<ul>",'times' => $this->_tpl_vars['node']['depth']-$this->_tpl_vars['node']['prevdepth']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:f3c29c583651fdf32d2d3501a0f7450f#0}'; endif;?>

<?php elseif ($this->_tpl_vars['node']['depth'] < $this->_tpl_vars['node']['prevdepth']): ?>
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:f3c29c583651fdf32d2d3501a0f7450f#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('f3c29c583651fdf32d2d3501a0f7450f','1');echo smarty_cms_function_repeat(array('string' => "</li></ul>",'times' => $this->_tpl_vars['node']['prevdepth']-$this->_tpl_vars['node']['depth']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:f3c29c583651fdf32d2d3501a0f7450f#1}'; endif;?>
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:f3c29c583651fdf32d2d3501a0f7450f#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('f3c29c583651fdf32d2d3501a0f7450f','2');echo smarty_cms_function_repeat(array('string' => "</li></ul>",'times' => $this->_tpl_vars['node']['depth']-1), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:f3c29c583651fdf32d2d3501a0f7450f#2}'; endif;?>
</li>
</ul>
...
<?php else: ?>
	...
	<div class="NewsSummaryContent">
		<?php if ($this->caching && !$this->_cache_including): echo '{nocache:f3c29c583651fdf32d2d3501a0f7450f#3}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('f3c29c583651fdf32d2d3501a0f7450f','3');echo smarty_function_eval(array('var' => $this->_tpl_vars['entry']->content), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:f3c29c583651fdf32d2d3501a0f7450f#3}'; endif;?>
...
<?php if (isset ( $this->_tpl_vars['entry']->extra )): ?>
    <div class="NewsSummaryExtra">
        <?php if ($this->caching && !$this->_cache_including): echo '{nocache:f3c29c583651fdf32d2d3501a0f7450f#4}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('f3c29c583651fdf32d2d3501a0f7450f','4');echo smarty_function_eval(array('var' => $this->_tpl_vars['entry']->extra), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:f3c29c583651fdf32d2d3501a0f7450f#4}'; endif;?>
...
:&nbsp;<?php if ($this->caching && !$this->_cache_including): echo '{nocache:f3c29c583651fdf32d2d3501a0f7450f#5}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('f3c29c583651fdf32d2d3501a0f7450f','5');echo smarty_function_eval(array('var' => $this->_tpl_vars['field']->value), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:f3c29c583651fdf32d2d3501a0f7450f#5}'; endif;?>
