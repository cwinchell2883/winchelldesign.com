...
/* SELECT image_name, image_filename, image_lang, image_height, image_width FROM _styles_imageset_data WHERE imageset_id = 2 AND image_filename <> '' AND image_lang IN ('en', '') */
