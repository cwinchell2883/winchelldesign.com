...
<?php if ($this->_rootref['S_EDIT_FORUM']) {  ?>
	...
	<div id="forum_post_options">
		...
		<dl>
			<dt><label for="display_subforum_list"><?php echo ((isset($this->_rootref['L_LIST_SUBFORUMS'])) ? $this->_rootref['L_LIST_SUBFORUMS'] : ((isset($user->lang['LIST_SUBFORUMS'])) ? $user->lang['LIST_SUBFORUMS'] : '{ LIST_SUBFORUMS }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_LIST_SUBFORUMS_EXPLAIN'])) ? $this->_rootref['L_LIST_SUBFORUMS_EXPLAIN'] : ((isset($user->lang['LIST_SUBFORUMS_EXPLAIN'])) ? $user->lang['LIST_SUBFORUMS_EXPLAIN'] : '{ LIST_SUBFORUMS_EXPLAIN }')); ?></span></dt>
			<dd><label><input type="radio" class="radio" name="display_subforum_list" value="1"<?php if ($this->_rootref['S_DISPLAY_SUBFORUM_LIST']) {  ?> id="display_subforum_list" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="display_subforum_list" value="0"<?php if (! $this->_rootref['S_DISPLAY_SUBFORUM_LIST']) {  ?> id="display_subforum_list" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
		<dl>
		...
		<!-- News forum -->
		<dl>
			<dt><label for="enable_news_forum"><?php echo ((isset($this->_rootref['L_ENABLE_NEWS_FORUM'])) ? $this->_rootref['L_ENABLE_NEWS_FORUM'] : ((isset($user->lang['ENABLE_NEWS_FORUM'])) ? $user->lang['ENABLE_NEWS_FORUM'] : '{ ENABLE_NEWS_FORUM }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_ENABLE_NEWS_FORUM_EXPLAIN'])) ? $this->_rootref['L_ENABLE_NEWS_FORUM_EXPLAIN'] : ((isset($user->lang['ENABLE_NEWS_FORUM_EXPLAIN'])) ? $user->lang['ENABLE_NEWS_FORUM_EXPLAIN'] : '{ ENABLE_NEWS_FORUM_EXPLAIN }')); ?></span></dt>
			<dd><label><input type="radio" class="radio" name="enable_news_forum" value="1"<?php if ($this->_rootref['S_NEWS_FORUM']) {  ?> id="enable_icons" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				 <label><input type="radio" class="radio" name="enable_news_forum" value="0"<?php if (! $this->_rootref['S_NEWS_FORUM']) {  ?> id="enable_icons" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
		<!-- /News forum -->
		</fieldset>
