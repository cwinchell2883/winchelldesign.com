 ...
 * @version $Id: Comments.php 7908 2011-02-01 15:53:53Z matt $
 */
...
class Comments {
    ...
    public function showRecentComments($limit)
    {
        ...
        $db->addJoin('left', 'comments_items', 'comments_threads', 'thread_id', 'id');
        $db->addJoin('left', 'comments_items', 'users', 'author_id', 'id');
        $db->addJoin('left', 'comments_threads', 'phpws_key', 'key_id', 'id');
