 ...
 * @version $Id: error.php 7346 2010-03-16 18:04:09Z matt $
 */
...
$errors[FC_COULD_NOT_DELETE]       = dgettext('filecabinet', 'Could not delete file.');
$errors[FC_IMAGE_DIMENSION]        = dgettext('filecabinet', 'Image is %spx by %spx, the maximum dimensions are %spx by %spx.');
$errors[FC_FILE_MOVE]              = dgettext('filecabinet', 'Unable to move the file to its new directory.');
$errors[FC_BAD_DIRECTORY]          = dgettext('filecabinet', 'Could not write to directory.');
...
$errors[FC_FILE_TYPE_MISMATCH]     = dgettext('filecabinet', 'Unacceptable file type.');
