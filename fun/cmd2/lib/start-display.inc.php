...
if(isset($_GET['yoohoo'])){ // this is purely for the SEO people
	// You get here by clicking on the cursor
	// Yay for crappy v1.0 code	
...
?>
<div id="welcome" style="visibility:hidden"><?php echo get_option('cli_welcome'); ?></div>
<noscript>
<p>Sorry, the CLI requires JavaScript to work. Please turn on JavaScript<?php if (get_option('cli_gui_url')){ ?>, 
or try the <a href="<?php echo get_option('cli_gui_url') ?>">GUI Interface</a>.
<?php }else{ echo ".";} ?>
</p>
</noscript>
