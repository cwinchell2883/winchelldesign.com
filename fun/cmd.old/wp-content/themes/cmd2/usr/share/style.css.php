...
body{
	...
	font-family:"<?php echo get_option('cli_font') ?>","Courier New",Courier,monospace;
	padding:0;
	margin:0;
	overflow:hidden;
} 
...
div#scr{
	...
	height:99%;
	margin:<?php echo get_option('cli_br_width') ?>px;
	padding:0;
	overflow:hidden;
	<?php if(get_option('cli_sidebar')=='left'){ ?>
	padding-left:<?php echo get_option('cli_br_width') ?>px;
	<?php }else if(get_option('cli_sidebar')=='right'){ ?>
	padding-right:<?php echo get_option('cli_br_width') ?>px;
	<?php } ?>
}
...
a#undercsr{
	font-weight:normal;
<?php if(get_option('cli_cursor_style') == 'underline'){ ?>
...
div#pagealert{
	...
	margin:0;
	padding:0;
	left:<?php echo get_option('cli_br_width') ?>px;
	bottom:<?php echo get_option('cli_br_width') ?>px;
	width:auto;
	text-align:center;
	background-color:<?php echo FG_COLOUR ?>;
	color:<?php echo BG_COLOUR ?>;
