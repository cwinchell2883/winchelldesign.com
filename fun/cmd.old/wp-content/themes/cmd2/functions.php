...
/* detect current OS */
function cli_os_detect(){
	$OSList = array(
		'3.1'		=> '(Win16)',
		'4.0.950'	=> '(Windows 95)|(Win95)|(Windows_95)',
		'4.0.1318'	=> '(Windows NT 4.0)|(WinNT4.0)|(WinNT)',
		'4.1.2222'	=> '(Windows 98)|(Win98)',
		'4.90.3000'	=> '(Windows ME)',
		'5.0.2195'	=> '(Windows NT 5.0)|(Windows 2000)',
		'5.1.2600'	=> '(Windows NT 5.1)|(Windows XP)',
		'5.2.3700'	=> '(Windows NT 5.2)',
		'6.0.6000'	=> '(Windows NT 6.0)',
		'6.1.7600'	=> '(Windows NT 7.0)|(Windows NT 6.1)',
	);
    ...
    if(eregi('3|4|5|6', $CurrOS)){
		$CurrOS = ' [Version ' . $CurrOS . ']';
		return $CurrOS;
	}
	else{
		$CurrOS = ' Command Prompt';
		return $CurrOS;
	}
}
