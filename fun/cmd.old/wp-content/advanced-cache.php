...
@define ("QUICK_CACHE_DONT_CACHE_WHEN_LOGGED_IN", 1);
@define ("QUICK_CACHE_DONT_CACHE_QUERY_STRING_REQUESTS", 1);
@define ("QUICK_CACHE_ALLOW_BROWSER_CACHE", 0);
@define ("QUICK_CACHE_EXPIRATION", 1);
@define ("QUICK_CACHE_DONT_CACHE_THESE_URIS", "/wp-app|wp-signup|wp-register|wp-activate|wp-login|wp-admin|xmlrpc/");
